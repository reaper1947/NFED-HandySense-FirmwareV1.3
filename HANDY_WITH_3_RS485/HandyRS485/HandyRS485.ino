...
ModbusMaster    light, temp_rs485, Soil_rs485;
MCP23008 MCP    (0x24);
...
void Get_soil() {
   uint8_t result_soil;
   result_soil = Soil_rs485.readHoldingRegisters(0, 2);
   if (result_soil == Soil_rs485.ku8MBSuccess) {
     ma_soil[4] = ma_soil[3];
     ma_soil[3] = ma_soil[2];
     ma_soil[2] = ma_soil[1];
     ma_soil[1] = ma_soil[0];
     //อ่านตำแหน่ง 0000
     ma_soil[0] = Soil_rs485.getResponseBuffer(0) / 10.00f;
